...
MBPP : 
./exams/exam_mbpp.sh --student-path student --moulinette-path moulinette --env-file .env --model-name "poolside/laguna-xs-2.1:free" --provider-url "https://openrouter.ai/api/v1"
SWE :
