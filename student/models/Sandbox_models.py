...
class SandboxConfig(BaseModel):
    authorized_imports: List[str] = ["math", "collections", "itertools"]
    allowed_directories: List[str] = ["/tmp/agent"]
...
async def main():
    ...
    sandbox = Sandbox(config=config, mcp_stdio="python student/mcp/mcp_tools_mbpp.py")
...
"""
    ...
    # test import autorisé
    code2 = """
import math
print(math.pi)
"""
    result2 = await sandbox.execute(code2)
    print("Import autorisé:", result2)
